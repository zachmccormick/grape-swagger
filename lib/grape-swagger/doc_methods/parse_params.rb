    ...
    class ParseParams
      class << self
        def call(param, settings, path, route, definitions, consumes) # rubocop:disable Metrics/ParameterLists
          ...
          # Usage: documentation: { ref: '...', summary: 'Override', description: 'Override' }
        ...
        def document_example(settings)
          ...
          # For body params or OpenAPI 3.1.0, use :example directly
          # For Swagger 2.0 non-body params, use x-example extension
        ...
        def document_examples(settings)
          ...
          # examples is a Map[string, Example Object] for OpenAPI 3.1.0
          # Each Example Object can have: summary, description, value, externalValue
