...
describe GrapeSwagger::OpenAPI::ContentNegotiator do
  # Story 6.1: Multiple Request Content Types - Tests for content negotiation
  ...
  # Story 6.2: Multiple Response Content Types - Tests for building content objects
  ...
  # Story 6.3: Content Type Encoding - Tests for multipart encoding
