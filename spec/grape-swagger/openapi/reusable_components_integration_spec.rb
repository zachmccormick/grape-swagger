...
describe 'Reusable Components Integration' do
  ...
  before(:all) do
    ...
    Object.const_set(:IntegrationPageParam, page_param) unless defined?(IntegrationPageParam)
    ...
    Object.const_set(:IntegrationPerPageParam, per_page_param) unless defined?(IntegrationPerPageParam)
    ...
    Object.const_set(:IntegrationNotFoundResponse, not_found_response) unless defined?(IntegrationNotFoundResponse)
    ...
    Object.const_set(:IntegrationUnauthorizedResponse, unauthorized_response) unless defined?(IntegrationUnauthorizedResponse)
    ...
    Object.const_set(:IntegrationRateLimitHeader, rate_limit_header) unless defined?(IntegrationRateLimitHeader)
