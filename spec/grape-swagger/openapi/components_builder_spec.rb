...
describe GrapeSwagger::OpenAPI::ComponentsBuilder do
  describe '.build' do
    ...
    context 'with version-aware reference translation' do
      let(:swagger_version) do
        GrapeSwagger::OpenAPI::Version.new(GrapeSwagger::OpenAPI::VersionConstants::SWAGGER_2_0)
      end
      let(:openapi_version) do
        GrapeSwagger::OpenAPI::Version.new(GrapeSwagger::OpenAPI::VersionConstants::OPENAPI_3_1_0)
      end
